...
public class VoirAnamnesesController implements Initializable {
    private Stage stage;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Text text = new Text("Nom Anamnéses                 Categorie");
        ...
        // infos des anamneses
        Iterator <Anamnese> it  = Main2Controller.gestion.listeAnamneses.iterator();
        while(it.hasNext()){
            Anamnese a = it.next();
            StackPane stack2 = new StackPane();
            stack2.setPrefSize(751, 100);
            stack2.setStyle("-fx-background-color: lightblue; ");
            Text text2 = new Text(a.getNomAnamnese()+"                "+a.getEnfant());
