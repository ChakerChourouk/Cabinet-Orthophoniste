...
public class VoirPatientsBoController implements Initializable {
private Stage stage;
private Parent root;
...
public void initialize(URL url, ResourceBundle resourceBundle) {
     ...
     Button accessFoldersButton = new Button("Passer Bo");
...
private void passerBo(Patient patient) throws Exception {
